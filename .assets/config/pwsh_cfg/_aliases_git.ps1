...
function ggr {
    Invoke-WriteExecuteCommand `
        -Command 'git grep --ignore-case' `
        -Arguments $args
}
function ggre {
    Invoke-WriteExecuteCommand `
        -Command 'git grep --ignore-case --extended-regexp' `
        -Arguments $args
}
function ggrp {
    Invoke-WriteExecuteCommand `
        -Command 'git grep --ignore-case --perl-regexp' `
        -Arguments $args
}
function ghh {
    Invoke-WriteExecuteCommand `
...
function glol {
    Invoke-WriteExecuteCommand `
        -Command 'git log --graph --pretty="%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr) %C(bold blue)<%an>%Creset" --abbrev-commit' `
        -Arguments $args
}
function glola {
    Invoke-WriteExecuteCommand `
