...
alias ktpo='kubectl top pods --use-protocol-buffers'
alias ktpocntr='kubectl top pods --use-protocol-buffers --containers'
alias kav='kubectl api-versions'
alias kcv='kubectl config view'
alias kcgctx='kubectl config get-contexts'
alias kcsctxcns='kubectl config set-context --current --namespace'
alias kcuctx='kubectl config use-context'
alias ksys='kubectl --namespace=kube-system'
alias ka='kubectl apply --recursive -f'
alias ksysa='kubectl --namespace=kube-system apply --recursive -f'
alias kak='kubectl apply -k'
alias kadrys='kubectl apply --recursive --dry-run=server -f'
alias kadryc='kubectl apply --recursive --dry-run=client -f'
...
alias kre='kubectl replace'
alias kref='kubectl replace -f'
alias kref!='kubectl replace --force -f'
...
alias kgporsrc='kubectl get pods --output custom-columns="NAMESPACE:.metadata.namespace,POD:.metadata.name,CONTAINER:.spec.containers[*].name,CPU_REQUEST:.spec.containers[*].resources.requests.cpu,CPU_LIMIT:.spec.containers[*].resources.limits.cpu,MEM_REQUEST:.spec.containers[*].resources.requests.memory,MEM_LIMIT:.spec.containers[*].resources.limits.memory"'
