...
alpine)
  ...
  ;;
fedora)
  dnf install -y "https://github.com/Azure/azure-storage-azcopy/releases/download/${REL}/azcopy-${REL}.x86_64.rpm" >&2 2>/dev/null
  ;;
debian | ubuntu)
  ...
  URL="https://github.com/Azure/azure-storage-azcopy/releases/download/${REL}/azcopy-${REL}.x86_64.deb"
...
*)
  ...
  TMP_DIR=$(mktemp -dp "$HOME")
  # calculate download uri
  URL="https://github.com/Azure/azure-storage-azcopy/releases/download/${REL}/azcopy_linux_amd64_${REL}.tar.gz"
  # download and install file
  if download_file --uri "$URL" --target_dir "$TMP_DIR"; then
