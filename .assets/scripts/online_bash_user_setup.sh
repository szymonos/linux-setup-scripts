...
# install dependencies on Debian based distro, then source the script to perform the setup
apt update && apt install -y curl
# install dependencies on Alpine based distro, then source the script to perform the setup
