...
.EXAMPLE
$Distro = 'Ubuntu'
wsl/wsl_flags_manage.ps1 $Distro
wsl/wsl_flags_manage.ps1 $Distro -Interop $true
wsl/wsl_flags_manage.ps1 $Distro -Interop $false
wsl/wsl_flags_manage.ps1 $Distro -AppendWindowsPath $true
